    ...
    return new GestureDetector(
        ...
        child: new Container(
          ...
          decoration: new BoxDecoration(
              border:
                  new Border.all(color: ColorPalette.PrimaryColor, width: 1.0),
              borderRadius: new BorderRadius.circular(50.0),
              color: Colors.white,
              boxShadow: [
                new BoxShadow(color: ColorPalette.PrimaryColor, blurRadius: 8.0)
              ]),
          child: new ImageIcon(new AssetImage("images/clap.png"),
              color: ColorPalette.PrimaryColor, size: 40.0),
        ));
  }
